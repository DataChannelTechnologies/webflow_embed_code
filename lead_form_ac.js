<style>
 ...
 #_form_19_ { position:relative; text-align:left; margin:25px auto 0; padding:20px; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; *zoom:1; background:transparent !important; border:0px solid #b0b0b0 !important; max-width:500px; -moz-border-radius:0px !important; -webkit-border-radius:0px !important; border-radius:0px !important; color:#303030 !important; }
 #_form_19_._inline-form,#_form_19_._inline-form ._form-content,#_form_19_._inline-form input,#_form_19_._inline-form ._submit { font-family:"Montserrat", sans-serif; }
...
<link href="https://fonts.googleapis.com/css2?family=Lato&family=Montserrat&family=Roboto&family=IBM+Plex+Sans:wght@400;600&display=swap" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="https://unpkg.com/intl-tel-input@17.0.18/build/css/intlTelInput.min.css"/>
    <form method="POST" action="https://datachannel.activehosted.com/proc.php" id="_form_19_" class="_form _form_19 _inline-form  _dark" novalidate>
      ...
      <input type="hidden" name="or" value="d9852fee7c0515d2e684ab126fe3ae94" />
      <div class="_form-content">
        <div class="_form_element _x54972682 _full_width _clear" >
          <div class="_html-code">
            <p>
              Speak to one of our experts to learn how DataChannel can help you make the most of your data
            </p>
          </div>
        </div>
        <div class="_form_element _x95679373 _full_width " >
        ...
        <div class="_form_element _x35201861 _full_width " >
          <label for="email" class="_form-label">
            Email*
          </label>
          <div class="_field-wrapper">
            <input type="text" id="email" name="email" placeholder="Please provide your business or company email" required/>
          </div>
        </div>
        <div class="_form_element _x54917491 _full_width " >
        ...
        <div class="_form_element _x29509776 _full_width " >
          <label for="field[5]" class="_form-label">
            Company Name
          </label>
          <div class="_field-wrapper">
            <input type="text" id="field[5]" name="field[5]" value="" placeholder="Please input your company name" />
          </div>
        </div>
        <div class="_form_element _x66585738 _full_width " >
...
window.cfields = {"5":"pipedrive-org-name"};
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://datachannel.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };
